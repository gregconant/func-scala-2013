...
*/
val problem = new Pouring(Vector(4, 9))           //> problem  : week7.Pouring = week7.Pouring@5175f214
...
problem.solution(6)                               //> res2: Stream[week7.caseStudyWaterPouringProblem05.problem.Path] = Stream(Fi
                                                  ...
                                                  //| Vector(4, 6), ?)
val problem2 = new Pouring(Vector(4, 9, 19))      //> problem2  : week7.Pouring = week7.Pouring@21b10e9e
