...
class ListsSuite extends FunSuite {
  ...
  test("sum of a few numbers") {
    ...
    assert(sum(List(1,2,2,2,2,2,2,2,2,2,0)) === 19)
  }
  ...
  test("sum of two numbers with a negative") {
 ...
 test("max of one number") {
  ...
  test("max of a few numbers") {
    ...
    assert(max(List(1,2,2,2,2,2,2,2,2,2,0)) === 2)
  }
  ...
  test("max of two numbers with a negative") {
